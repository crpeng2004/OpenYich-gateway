package com.openyich.cloud.gateway.security.basic;
...
import com.openyich.cloud.gateway.security.jwt.JWTTokenService;
...
public class BasicAuthenticationSuccessHandler implements ServerAuthenticationSuccessHandler {
  ...
  private static String tokenFromAuthentication(Authentication authentication) {
    return JWTTokenService.generateToken(authentication.getName(), authentication.getCredentials(),
